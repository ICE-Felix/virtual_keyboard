...
import 'package:virtual_keyboard/src/features/virtual_keyboard/widgets/virtual_keyboard_manager.dart';

class VirtualKeyboardScaffold extends StatelessWidget {
  /// The decorations to apply to the virtual keyboard.
  ///
  /// This property allows you to customize the appearance of the virtual keyboard,
  /// such as the background color, border, and padding of the keys.
  final VirtualKeyboardStyle? keyboardDecorations;

  /// The maximum number of keys that can be displayed on the virtual keyboards.
  final int maxKeysOnKeyboards;

  /// The maximum height of the virtual keyboards.
  final double? maxHeightOfKeyboards;
      ...
      child: Scaffold(
        ...
        body: Builder(builder: (context) {
          return VirtualKeyboardManager(
            key: UniqueKey(),
            maxKeys: maxKeysOnKeyboards,
            keyPadding: keyPadding,
            keyboardPadding: keyboardPadding,
            maxHeight: maxHeightOfKeyboards,
            decorations: keyboardDecorations,
